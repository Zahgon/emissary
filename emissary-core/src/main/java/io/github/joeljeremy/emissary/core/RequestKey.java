...
public abstract class RequestKey<T extends Request<R>, R> {
    ...
    private static final ResultTypeByRequestType RESULT_TYPE_BY_REQUEST_TYPE = new ResultTypeByRequestType();
    ...
    private static class ResultTypeByRequestType extends ClassValue<Type> {
         ...
         */
        private static Type resolveActualTypeParameter(Type requestType, TypeVariable<?> requestTypeParameter) {
            Map<TypeVariable<?>, Type> typeVariableMapping = resolveTypeVariableMapping(requestType, new HashMap<>());
         ...
         */
        private static Map<TypeVariable<?>, Type> resolveTypeVariableMapping(Type type, Map<TypeVariable<?>, Type> typeVariableMapping) {
            if (type == null) {
